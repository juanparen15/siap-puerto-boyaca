<!DOCTYPE html>
<html lang="es">
<head><meta charset="UTF-8"><title>PQRS Radicada</title></head>
<body style="font-family: Arial, sans-serif; background:#f4f4f4; padding:20px;">
    <div style="max-width:600px; margin:auto; background:#fff; border-radius:8px; overflow:hidden;">
        <div style="background:#3366CC; padding:24px; text-align:center;">
        ...
        <div style="padding:32px;">
            <h2 style="color:#3366CC;">Su PQRS ha sido radicada</h2>
            <p>Número de radicado: <strong>{{ $pqrs->radicado }}</strong></p>
            <p>Tipo: {{ ucfirst($pqrs->tipo_solicitud) }}</p>
            <p>Estado: <strong>Radicada</strong></p>
            <p style="margin-top:24px;">Puede consultar el estado de su solicitud en cualquier momento:</p>
            <a href="{{ url('/pqrs/consultar') }}" style="display:inline-block; background:#3366CC; color:#fff; padding:12px 24px; border-radius:6px; text-decoration:none;">Consultar mi PQRS</a>
        </div>
